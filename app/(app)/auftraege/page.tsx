        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          {mergeStep === 2 &&
            (() => {
              ...
              const mainOrder =
                selectedOrders.find((o) => o.id === selectedMainOrderId) ||
                selectedOrders[0] ||
                null;
              const effectiveCustomerId =
                selectedCustomerId ||
                mainOrder?.customerId ||
                uniqueCustomers[0]?.id ||
                "";
              ...
              return (
                <>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Wähle den Hauptauftrag. Bilder, Textvorschau und
                    Audio-Hinweise helfen dir beim Abgleich.
                  </p>
                    ...
                    <div className="p-3 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded mt-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-amber-800 dark:text-amber-200 font-medium">
                          Mehrere Aufträge mit Audio erkannt. Bitte nur einen
                          Audio-Auftrag auswählen.
                        </span>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="mt-6 p-4 bg-slate-50 dark:bg-slate-900/40 rounded space-y-2">
                    ...
                    {hasCustomerMismatch && (
                      <div className="text-sm text-amber-600 dark:text-amber-400">
                        ⚠️ Die ausgewählten Aufträge haben unterschiedliche
                        Kunden.
                      </div>
                    )}
                  </div>
                  ...
                  <DialogFooter className="mt-4 flex-row justify-between sm:justify-between">
                    ...
                    <Button
                      onClick={mergeGoToStep3}
                      disabled={!selectedMainOrderId || audioOrdersCount > 1}
                    >
                      Weiter
          ...
          {mergeStep === 3 &&
            (() => {
              ...
              const finalCustomerId =
                selectedCustomerId || mainOrder?.customerId || null;
              const finalCustomer = finalCustomerId
                ? customers.find((c) => c.id === finalCustomerId)
                : null;
              const totalImages = selectedOrders.reduce(
                (sum, o) => sum + (o.imageUrls?.length || 0),
                0,
              );
              const sourceOrdersCount = selectedOrders.filter(
                (o) => o.id !== selectedMainOrderId,
              ).length;
              const allChecked =
                confirmChecks.contentBelongsTogether &&
                confirmChecks.trashUnderstood;
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-blue-50 border border-blue-200 rounded">
                      ...
                      <div className="text-sm text-blue-700 mt-1">
                        ...
                        aus allen ausgewählten Aufträgen
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        ...
                        <div className="font-medium truncate">
                          {mainOrder?.serviceName ||
                            mainOrder?.description ||
                            "–"}
                        </div>
                      </div>
                      <div>
                    ...
                    <div className="text-xs text-slate-600 dark:text-slate-300 p-3 bg-slate-50 dark:bg-slate-900/40 rounded">
                      ...
                      Leistungen, Preise, Termine, Priorität, Zuweisungen und
                      KI-Texte aus Bild-ohne-Text-Aufträgen.
                    </div>
                    ...
                    <div className="space-y-3">
                      <label className="flex items-start gap-3 cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            setConfirmChecks((prev) => ({
                              ...prev,
                              contentBelongsTogether: e.target.checked,
                            }))
                          }
                          disabled={merging}
                          className="mt-1"
                        ...
                        <span className="text-sm">
                          Ich habe geprüft, dass die Bilder und Inhalte
                          zusammengehören.
                        </span>
                      </label>
                      ...
                      <label className="flex items-start gap-3 cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            setConfirmChecks((prev) => ({
                              ...prev,
                              trashUnderstood: e.target.checked,
                            }))
                          }
                          disabled={merging}
                          className="mt-1"
                        />
                        <span className="text-sm">
                          Die übrigen Aufträge werden in den Papierkorb
                          verschoben.
                        </span>
                      </label>
                    </div>
  ...
  />
                ...
                `orderVatRate` is local-only state and is NOT sent to the API. */}
                    ...
                    <div className="space-y-1 border-t pt-2 min-w-0 text-xs sm:text-sm">
                      ...
                      <div className="flex justify-between font-bold border-t pt-2 min-w-0 text-sm sm:text-base">
                        ...
                        <span className="font-mono text-primary">
                          {formatCurrency(
                            itemsTotal + (itemsTotal * orderVatRate) / 100,
                            currency,
                          )}
                        </span>
                      </div>
                  ...
                  <CommunicationBlock
                    ...
                    onSpecialNotesChange={(val) =>
                      setForm({ ...form, specialNotes: val })
                    }
                  />
                </>
              )}
              ...
              {!showNewCustomer && !dupCheckOpen && (
                <div className="flex flex-wrap justify-center sm:justify-end gap-2 mb-20 md:mb-0">
                  ...
                  <Button
                    ...
                    disabled={saving}
                    className="bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200 text-xs sm:text-sm"
                  >
                  ...
                  <Button
                    ...
                    disabled={saving}
                    className="bg-green-50 text-green-700 hover:bg-green-100 border border-green-200 text-xs sm:text-sm"
                  >
