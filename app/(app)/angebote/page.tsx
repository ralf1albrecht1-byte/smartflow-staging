                                ...
                                <div className="relative grid min-w-0 grid-cols-1 items-start gap-x-3 gap-y-1 sm:grid-cols-[minmax(0,1fr)_auto]">
                                  ...
                                  >
                                    <button
                                      ...
                                      className="group relative inline-flex h-8 w-8 min-w-0 max-w-full shrink items-center justify-center rounded-full border border-violet-300 bg-violet-50 px-0 text-xs font-semibold text-violet-800 shadow-sm hover:bg-violet-100 lg:w-auto lg:max-w-[6.5rem] lg:px-2.5 xl:max-w-[10rem] 2xl:max-w-[12rem]"
                                    >
                                      ...
                                      <span className="sr-only lg:hidden">{appointmentChipLabels.full}</span>
                                      {!useTouchChipPopovers && (
                                ...
                                <div className="relative mt-2 flex flex-col gap-2 border-t border-slate-200 pt-2 dark:border-slate-700 sm:flex-row sm:items-end sm:justify-between sm:gap-3">
                                  ...
                                  >
                                    <button
                                      ...
                                      className="group relative inline-flex h-8 w-8 min-w-0 max-w-full shrink items-center justify-center rounded-full border border-violet-300 bg-violet-50 px-0 text-xs font-semibold text-violet-700 shadow-sm hover:bg-violet-100 lg:w-auto lg:max-w-[6.5rem] lg:px-2.5 xl:max-w-[10rem] 2xl:max-w-[12rem]"
                                    >
                                      <CalendarDays className="h-3.5 w-3.5 shrink-0" />
                                      <span className="hidden min-w-0 truncate xl:ml-1.5 xl:inline">
                                        {appointmentChipLabels.full}
